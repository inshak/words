...
.fb-d2-ele-flip-box__button
{
	...
	background:<?php echo $flipbuttonbackccolor; ?> ;
...
.fb-d2-ele-flip-box__button:hover
{
	...
	background:<?php echo $flipbuttonbackhcolor; ?> ;
...
.fb-d2-eael-elements-flip-box-content
{
	...
	color:<?php echo $flipdesccolor; ?> !important;
	text-align:<?php echo $flip_textalign; ?> ;
...
{
	background:<?php echo $flipfrontcolor; ?> ;
}
.fb-d2-eael-elements-flip-box-rear-container
{
	background:<?php echo $flipbackgcolor; ?> ;
}	
...
?>
<div class="col-md-<?php echo $flip_itemperrow?> col-sm-6 flipbox-col-sm-4 fb-design-2-col ">
		...
		<div class="fb-d2-parent-container fb-d2-parent-column-gap-extended">
			<div class="fb-d2-parent-row">
												...
												<div class="fb-d2-eael-elements-slider-display-table">
													<div class="fb-d2-eael-elements-flip-box-vertical-align">
														<div class="fb-d2-eael-elements-flip-box-padding">
															<div class="fb-d2-eael-elements-flip-box-icon-image"> <i class=" <?php echo $front_icon; ?>" aria-hidden="true"></i> </div>
															<h2 class="fb-d2-eael-elements-flip-box-heading"><?php echo substr($front_title,0,17); ?></h2>
				...
				echo substr($back_description,0,80);
															...
															<a class="fb-d2-ele-flip-box__button fb-d2-parent-button fb-d2-parent-size-sm" href="<?php echo $back_link; ?>" <?php if($flip_linkopen=="New Tab"){ ?>target="_blank"<?php } ?> style="display:<?php if($back_link=="" || $back_link=="#") { echo "none"; } ?>">
														<?php echo $btntext; ?>
													</a>
														</div>
													</div>
