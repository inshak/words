...
?>
<div class="col-md-<?php echo $flip_itemperrow?> col-sm-6 flipbox-col-sm-4 fb-design-9-col">
										...
										<div class="fb-d9-stel-pack-flip-box-layer fb-d9-stel-pack-flip-box-front">
											<div class="fb-d9-stel-pack-flip-box-layer-overlay">
												<div class="fb-d9-stel-pack-flip-box-layer-inner">
													<div class="fb-d9-parent-icon-wrapper fb-d9-parent-view-stacked fb-d9-parent-shape-square"><span class="fb-d9-parent-icon"><i aria-hidden="true" class="<?php echo $front_icon; ?>"></i></span></div>
													<h3 class="fb-d9-stel-pack-flip-box-layer-title"><?php echo substr($front_title,0,20); ?></h3></div>
											</div>
										</div>
										<div class="fb-d9-stel-pack-flip-box-layer fb-d9-stel-pack-flip-box-back">
											<div class="fb-d9-stel-pack-flip-box-layer-overlay">
												<div class="fb-d9-stel-pack-flip-box-layer-inner">
													<h3 class="fb-d9-stel-pack-flip-box-layer-title"><?php echo substr($front_title,0,17); ?></h3>
													<div class="fb-d9-stel-pack-flip-box-layer-description">
														<?php echo substr($back_description,0,80); ?>
													</div>
													<a class="fb-d9-stel-pack-flip-box-button fb-d9-parent-button fb-d9-parent-size-sm fb-d9-parent-animation-buzz-out" href="<?php echo $back_link; ?>" <?php if($flip_linkopen=="New Tab"){ ?>target="_blank"<?php } ?> style="display:<?php if($back_link=="" || $back_link=="#") { echo "none"; } ?>">
														<?php echo $btntext; ?>
													</a>
												</div>
											</div>
