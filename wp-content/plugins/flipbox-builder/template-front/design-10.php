...
?>
<div class="col-md-<?php echo $flip_itemperrow?> col-sm-6 flipbox-col-sm-4 fb-design-10-col">
								...
								<div class="fb-d10-ele-parent-widget-container">
									<div class="fb-d10-stel-pro-widget-flip-box-minimal-wrapper">
										<div class="fb-d10-stel-pack-flip-box-layer fb-d10-stel-pack-flip-box-front">
											<div class="fb-d10-fb-d10-stel-pack-flip-box-layer-overlay">
												<div class="fb-d10-stel-pack-flip-box-layer-inner">
													<div class="fb-d10-ele-parent-image-wrapper"><img src="<?php if($flip_image_id==null || $flip_image_id=='' || $flip_image_id==0){ echo $flip_image_field; } else{  echo $url['0']; } ?>"
													alt="Front Image"/></div>
													<h3 class="fb-d10-stel-pack-flip-box-layer-title"><?php echo substr($front_title,0,20); ?></h3>
										...
										<div class="fb-d10-stel-pack-flip-box-layer fb-d10-stel-pack-flip-box-back">
											<div class="fb-d10-fb-d10-stel-pack-flip-box-layer-overlay">
												<div class="fb-d10-stel-pack-flip-box-layer-inner">
													<h3 class="fb-d10-stel-pack-flip-box-layer-title">About <?php echo substr($front_title,0,17); ?></h3>
													<div class="fb-d10-stel-pack-flip-box-layer-description">
														<?php echo substr($back_description,0,80); ?>
													</div>
													<a class="fb-d10-stel-pack-flip-box-button fb-d10-ele-parent-button fb-d10-ele-parent-size-sm fb-d10-ele-parent-animation-" href="<?php echo $back_link; ?>" <?php if($flip_linkopen=="New Tab"){ ?>target="_blank"<?php } ?> style="display:<?php if($back_link=="" || $back_link=="#") { echo "none"; } ?>">
														<?php echo $btntext; ?>
													</a>
												</div>
											</div>
