...
?>
<div class="col-md-<?php echo $flip_itemperrow?> col-sm-6 flipbox-col-sm-4 fb-design-3-col">
			...
			<div class="fb-d3-parent-row">
											...
											<div class="fb-d3-ele-flip-box__layer__overlay">
												<div class="fb-d3-ele-flip-box__layer__inner">
													<div class="fb-d3-parent-icon-wrapper fb-d3-parent-view-default">
														<div class="fb-d3-parent-icon"> <i class="<?php echo $front_icon; ?>"></i> </div>
													</div>
				...
				echo substr($back_description,0,80);
										...
										<div class="fb-d3-ele-flip-box__layer fb-d3-ele-flip-box__back">
											<div class="fb-d3-ele-flip-box__layer__overlay">
												<div class="fb-d3-ele-flip-box__layer__inner">
													<a class="fb-d3-ele-flip-box__button fb-d3-parent-button fb-d3-parent-size-sm" href="<?php echo $back_link; ?>" <?php if($flip_linkopen=="New Tab"){ ?>target="_blank"<?php } ?> style="display:<?php if($back_link=="" || $back_link=="#") { echo "none"; } ?>">
														<?php echo $btntext; ?>
													</a>
												</div>
											</div>
