...
?>
<div class="col-md-<?php echo $flip_itemperrow?> col-sm-6 flipbox-col-sm-4 fb-design-6-col">
										...
										<div class="fb-d6-stel-pack-flip-box-layer fb-d6-stel-pack-flip-box-front">
											<div class="fb-d6-stel-pack-flip-box-layer-overlay">
												<div class="fb-d6-stel-pack-flip-box-layer-inner">
													<div class="fb-d6-ele-icon-wrapper fb-d6-ele-view-stacked fb-d6-ele-shape-circle"><span class="fb-d6-ele-icon"><i aria-hidden="true" class="<?php echo $front_icon; ?>"></i></span></div>
													<h3 class="fb-d6-stel-pack-flip-box-layer-title"><?php echo substr($front_title,0,20); ?></h3></div>
											</div>
										</div>
										<div class="fb-d6-stel-pack-flip-box-layer fb-d6-stel-pack-flip-box-back">
											<div class="fb-d6-stel-pack-flip-box-layer-overlay">
												<div class="fb-d6-stel-pack-flip-box-layer-inner">
													<h3 class="fb-d6-stel-pack-flip-box-layer-title"><?php echo substr($front_title,0,17); ?></h3>
													<div class="fb-d6-stel-pack-flip-box-layer-description">
														<?php echo substr($back_description,0,80); ?>
													</div>
													<a class="fb-d6-stel-pack-flip-box-button fb-d6-ele-button fb-d6-ele-size-sm fb-d6-ele-animation-wobble-skew" href="<?php echo $back_link; ?>" <?php if($flip_linkopen=="New Tab"){ ?>target="_blank"<?php } ?> style="display:<?php if($back_link=="" || $back_link=="#") { echo "none"; } ?>">
														<?php echo $btntext; ?>
													</a>
												</div>
											</div>
