...
.fb-d4-stel-pack-flip-box-button
{
	...
	border:solid 2px <?php echo $flipbuttonborderccolor; ?> ;
}
.fb-d4-stel-pack-flip-box-button:hover
{
	...
	border:solid 2px <?php echo $flipbuttonhbordercolor; ?> ;
}
...
.fb-d4-parent-icon
{
	...
	color:<?php echo $flipiconcolor; ?> ;
	background:<?php echo $flipbackcolor; ?> ;
	line-height:<?php echo $flip_icon_height; ?>px  ;
...
.fb-d4-parent-530 .fb-d4-parent-element.fb-d4-parent-element-1cc10c4 .fb-d4-fb-d4-stel-pro-widget-flip-box-minimal-wrapper .fb-d4-stel-pack-flip-box-front .fb-d4-parent-icon {
	font-size: <?php  echo $flip_icon_size;  ?>px !important;
...
?>
<div class="col-md-<?php echo $flip_itemperrow?> col-sm-6 flipbox-col-sm-4 fb-design-4-col">
										...
										<div class="fb-d4-stel-pack-flip-box-layer fb-d4-stel-pack-flip-box-front">
											<div class="fb-d4-stel-pack-flip-box-layer-overlay">
												<div class="fb-d4-stel-pack-flip-box-layer-inner">
													<div class="fb-d4-parent-icon-wrapper fb-d4-parent-view-framed fb-d4-parent-shape-circle"><span class="fb-d4-parent-icon"><i aria-hidden="true" class="<?php echo $front_icon; ?>"></i></span></div>
													<h3 class="fb-d4-stel-pack-flip-box-layer-title"><?php echo substr($front_title,0,20); ?></h3>
													<div class="fb-d4-stel-pack-flip-box-layer-description">
														<?php echo substr($back_description,0,40); ?>
													</div>
												</div>
											</div>
										</div>
										<div class="fb-d4-stel-pack-flip-box-layer fb-d4-stel-pack-flip-box-back">
											<div class="fb-d4-stel-pack-flip-box-layer-overlay">
												<div class="fb-d4-stel-pack-flip-box-layer-inner">
													...
													<a class="fb-d4-stel-pack-flip-box-button fb-d4-ele-button fb-d4-parent-size-sm fb-d4-parent-animation-grow" href="<?php echo $back_link; ?>" <?php if($flip_linkopen=="New Tab"){ ?>target="_blank"<?php } ?> style="display:<?php if($back_link=="" || $back_link=="#") { echo "none"; } ?>">
														<?php echo $btntext; ?>
													</a>
												</div>
											</div>
