...
?>
<div class="col-md-<?php echo $flip_itemperrow?> col-sm-6 flipbox-col-sm-4 fb-design-5-col">
										...
										<div class="fb-d5-stel-pack-flip-box-layer fb-d5-stel-pack-flip-box-front">
											<div class="fb-d5-stel-pack-flip-box-layer-overlay">
												<div class="fb-d5-stel-pack-flip-box-layer-inner">
													<div class="fb-d5-parent-icon-wrapper fb-d5-parent-view-framed fb-d5-parent-shape-circle"><span class="fb-d5-parent-icon"><i aria-hidden="true" class="<?php echo $front_icon; ?>"></i></span></div>
													<h3 class="fb-d5-stel-pack-flip-box-layer-title"><?php echo substr($front_title,0,17); ?></h3>
										...
										<div class="fb-d5-stel-pack-flip-box-layer fb-d5-stel-pack-flip-box-back">
											<div class="fb-d5-stel-pack-flip-box-layer-overlay">
												<div class="fb-d5-stel-pack-flip-box-layer-inner">
													...
													<a class="fb-d5-stel-pack-flip-box-button fb-d5-parent-button fb-d5-parent-size-sm fb-d5-parent-animation-wobble-skew" href="<?php echo $back_link; ?>" <?php if($flip_linkopen=="New Tab"){  ?>target="_blank"<?php } ?> style="display:<?php if($back_link=="" || $back_link=="#") { echo "none"; } ?>">
														<?php echo $btntext; ?>
													</a>
												</div>
											</div>
