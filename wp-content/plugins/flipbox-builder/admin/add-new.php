		...
		<ul class="clearfix" id="Flipbox_panel">
			...
			if($TotalCount) 
			{
				...
				<li class="Flipbox_ac-panel Flipbox_single_acc_box"> <span class="flipbox_ac_label "><?php _e('Title','flipbox-builder-text-domain'); ?></span>
					...
					<input  name="front_icon[]" class="icon-class-input" value="<?php echo esc_attr($front_icon); ?>" type="text" readonly="readonly" class="flipbox_ac_label_text" /><span class="demo-icon <?php echo esc_attr($front_icon); ?>"></span> <button type="button" class="fb-btn-iconpicker picker-button">Pick an Icon</button> </div>					
					<div id="iconPicker" class="modal fade">
					<div class="modal-dialog">
					<div class="modal-content">
					<div class="modal-header">				
					<h4 class="modal-title h4">Icon Picker</h4>
					...
					<div style="display:none;" class="myplugin-upload-wrap d10f flip_image_class"> <img class="upimgflip" src="<?php echo $flip_image_field; ?>" width="250" /></div>
					 <input class="inimg d10f flip_image_class" type="hidden" name="flip_image_field[]" value="<?php echo $flip_image_field;?>" />
					<button onclick="flipbox_media_upload(this)" type="button" class="fb-btn-success wpm_choosen_style d10f flip_image_class flip_upload_image_button">Upload Image</button>
					<input type="hidden" name="flip_image_id[]" value="<?php echo $flip_image_id; ?>" class="image-id-access d10f flip_image_class" /><br/>					
					<span style="" class="flipbox_ac_label d12f flip_button_class"><?php _e('Button','flipbox-builder-text-domain'); ?></span>
					<input style="" type="text" name="btntext[]" placeholder="Enter Button Text Here" class="flipbox_ac_label_text d12f flip_button_class" value="<?php echo esc_attr($btntext); ?>" /> <span style="" class="flipbox_ac_label d12f flip_button_class">Add Your Link Or Read More Link Here (With http://or https://)</span>
			...
			?>
					<li class="Flipbox_ac-panel Flipbox_single_acc_box"> <span class="flipbox_ac_label"><?php _e('Title','flipbox-builder-text-domain'); ?></span>
						...
						<div class="d10if flip_icon_class">
						<input  name="front_icon[]" class="icon-class-input" value="fa fa-laptop" type="text" readonly="readonly" class="flipbox_ac_label_text" /><span class="demo-icon fa fa-laptop"></span> <button type="button" class="fb-btn-iconpicker picker-button">Pick an Icon</button> </div>
						<div id="iconPicker" class="modal fade">
						<div class="modal-dialog">
						<div class="modal-content">
						<div class="modal-header">
						...
						<span class="flipbox_ac_label"><?php _e('Description','flipbox-builder-text-domain'); ?></span>
						<textarea name="back_description[]" placeholder="Enter Description Here" class="flipbox_ac_label_text">Sample Description Here</textarea> <span style="display:none;" class="flipbox_ac_label d10f flip_image_class"><?php _e('Upload Image','flipbox-builder-text-domain'); ?></span>
						<div style="display:none;" class="myplugin-upload-wrap d10f flip_image_class"> <img class="upimgflip" src="<?php echo FLIPBOXBUILDER_URL.'admin/images/flipbox-demo-3.jpg' ?>" width="250" />
						</div>	
						<input class="inimg d10f flip_image_class" type="hidden" name="flip_image_field[]" value="<?php echo FLIPBOXBUILDER_URL.'admin/images/flipbox-demo-3.jpg' ?>" /> 
						<button onclick="flipbox_media_upload(this)" type="button" class="fb-btn-success wpm_choosen_style d10f flip_image_class flip_upload_image_button">Upload Image</button>
						<input type="hidden" name="flip_image_id[]" value="0" class="image-id-access d10f flip_image_class"/><br/>						
						<span style="" class="flipbox_ac_label d12f flip_button_class"><?php _e('Button','flipbox-builder-text-domain'); ?></span>
						<input style="" type="text" id="btntext[]" name="btntext[]" placeholder="Enter Button Text Here" class="flipbox_ac_label_text d12f flip_button_class" value="Click Here" /> <span style="" class="flipbox_ac_label d12f flip_button_class">Add Your Link Or Read More Link Here (With http://or https://)</span>
