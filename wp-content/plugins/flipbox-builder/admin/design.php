...
<ul class="nav nav-tabs" id="myTab" role="tablist">
	<li class="nav-item"> <a class="nav-link active" id="Design-tab" data-toggle="tab" href="#Design" role="tab" aria-controls="Design" aria-selected="true">Design</a> </li>
	<li class="nav-item"> <a class="nav-link" id="Flipbox-tab" data-toggle="tab" href="#Flipbox" role="tab" aria-controls="Flipbox" aria-selected="false">Flipbox</a> </li>
	<li class="nav-item"> <a class="nav-link" id="Setting-tab" data-toggle="tab" href="#Setting" role="tab" aria-controls="Setting" aria-selected="false">Setting</a> </li>
	...
	<li class="nav-item"> <a class="nav-link" id="Shortcode-tab" data-toggle="tab" href="#Shortcode" role="tab" aria-controls="Shortcode" aria-selected="false">Shortcode</a> </li>
</ul>
<div class="tab-content" id="myTabContent">
	<div class="tab-pane fade show active" id="Design" role="tabpanel" aria-labelledby="Design-tab">
		<h1 class="fb-6310-template-list fb-h1-design" >Select Flipbox Layout</h1>
	...
	<div class="tab-pane fade" id="Flipbox" role="tabpanel" aria-labelledby="Flipbox-tab">
		<h1 class="fb-6310-template-list fb-h1-design" >Add New Flipbox</h1>
	...
	<div class="tab-pane fade" id="Css" role="tabpanel" aria-labelledby="Css-tab">
		<h1 class="fb-6310-template-list fb-h1-design" >Add Custom Css</h1>
		<textarea class="textareafocus custom-css-textarea" name="flip_custom_css" id="flip_custom_css" style=""><?php echo $flip_custom_css; ?></textarea>		
	...
	<div class="tab-pane fade" id="Shortcode" role="tabpanel" aria-labelledby="Shortcode-tab">
		<h1 class="fb-6310-template-list fb-h1-design" >Flipbox Shortcode</h1>
...
<button type="button" class="prevtab btnprevnext">Prev</button>
<button type="button" class="nexttab  btnprevnext btnprevnext1">Next</button></center>
<!-- /.container -->
...
jQuery(document).ready(function($) {
	...
	select_template(<?php echo $templates; ?>);
...
function default_setting_function(id) {
	if(id == 1) {
		...
		jQuery('.upimgflip').attr('src', "<?php echo FLIPBOXBUILDER_URL.'admin/images/flipbox-demo-3.jpg' ?>");
		jQuery('.inimg').attr('value', "<?php echo FLIPBOXBUILDER_URL.'admin/images/flipbox-demo-3.jpg' ?>");
	...
	if(id == 8) {
		...
		jQuery('.upimgflip').attr('src', "<?php echo FLIPBOXBUILDER_URL.'admin/images/Daniel-1.jpg' ?>");
		jQuery('.inimg').attr('value', "<?php echo FLIPBOXBUILDER_URL.'admin/images/Daniel-1.jpg' ?>");
	...
	if(id == 10) {
		...
		jQuery('.upimgflip').attr('src', "<?php echo FLIPBOXBUILDER_URL.'admin/images/team-thumb6.jpg' ?>");
		jQuery('.inimg').attr('value', "<?php echo FLIPBOXBUILDER_URL.'admin/images/team-thumb6.jpg' ?>");
